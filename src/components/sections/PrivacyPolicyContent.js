...
const PrivacyPolicyContent = () => {
  return (
    <StyledPrivacy className="privacy sec" id="zobacz">
      <div className="max-width">
        <div className="wrapper">
          <div className="column">
            <h2>Skrócona wersja</h2>
          ...
          <div className="column">
            ...
            <ul>
              <li>Przetwarzamy Twoje dane osobowe, które gromadzimy w związku z korzystaniem przez Ciebie z naszej strony oraz jej poszczególnych funkcji takich jak złożenie zamówienia poprzez formularz kontaktowy.</li>
              <li>Pośród danych osobowych, które przetwarzamy, mogą znajdować się, w szczególności, następujące informacje: imię i nazwisko, adres e-mail, numer telefonu.</li>
              <li>Powierzamy przetwarzanie Twoich danych osobowych tylko sprawdzonym i zaufanym podmiotom świadczącym usługi związane z przetwarzaniem danych osobowych.</li>
              <li>Nie korzystamy z mechanizmów profilowania wykorzystujących dane osobowe.</li>
        ...
        <div className="wrapper">
          <div className="column">
            <h2>Dane osobowe</h2>
            <p>Administratorem Twoich danych osobowych jest Foto Studio Adam Chrapek. Cele, podstawy prawne oraz okres przetwarzania danych osobowych wskazane są odrębnie w stosunku do każdego celu przetwarzania danych.</p>
          </div>
          <div className="column">
...
const StyledPrivacy = styled.section`
  ...
  padding: ${180/10.8}vh 0;
  .wrapper {
    position: relative;
    &:not(:last-child){
      margin-bottom: ${270/10.8}vh;
    }
    .column:first-child {
      margin-bottom: 5%;
    }
